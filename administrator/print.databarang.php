...
<div class="container" style="margin-top: 5rem;">
	<div class="card mt-2">
		<div class="card-body">
			<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#tambah-data"> <i class="fa-sharp fa-thin fa-plus">
					Tambah Data
			</button></i>
		</div>
		<div class="card-body">
			...
			?>
			<table id="taruna" class="table align-middle cell-border table-hover">
				<thead>
					<tr>
						<th>No</th>
						<th>Nama Produk</th>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<form method="post" action="proses_hapus_barang.php">
										<div class="modal-body">
											<input type="hidden" name="ProdukID" value="<?php echo $d['ProdukID']; ?>"><i class="fa-sharp fa-thin fa-exclamation">
												Apakah anda yakin akan menghapus data</i> <b><?php echo $d['NamaProduk']; ?></b>
										</div>
										<div class="modal-footer">
											<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
