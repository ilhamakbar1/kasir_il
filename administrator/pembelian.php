...
<div class="container" style="margin-top: 5rem;">
	<div class="card mt-2">
		<div class="card-body">
			...
			<a href="Print_pembelian.php" target="_blank" class="d-none d-sm-inline-block btn btn-sm
			btn-success shadow-sm"><i class="fas fa-print fa-sm text-white" style="height: 11px; margin-top:11px;"> Cetak Laporan</i></a>
		</div>
		<div class="card-body">
			<?php
			if (isset($_GET['pesan'])) {
